...
parfor i = 1:numel(source_to_lens_distances)
    ...
    compiled_data(i,:) = [lens_length lens_radius electrode_radius source_to_lens_distance efficiency_mu efficiency_sigma gain_mu gain_sigma f_fp_mu f_fp_sigma n_alive N_molecules];
