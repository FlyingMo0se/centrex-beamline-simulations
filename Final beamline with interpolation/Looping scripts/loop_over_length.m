...
parfor i = 1:numel(lens_lengths)
    for j = 1:numel(lens_radii)
        for k = 1:numel(electrode_radii)
            ...
            %Store the results
            [n_alive, n_fp, numbers_of_hits] = electrostatic_lens_function(lens_length, lens_radius, electrode_radius,source_to_lens_distance,lens_voltage, J, N_molecules, false);
